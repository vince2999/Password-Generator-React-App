  ...
  return (
    <>
      ...
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 bg-teal-400'>
        <div className='flex shadow rounded-lg overflow-hidden mb-4'><input type="text" className='outline-none w-full py-1 px-3 my-3' value={password} placeholder='password' readOnly />

          <button className='outline-none bg-blue-700 text-white px-3 py-.05 shrink-0 my-3'>copy</button>
        </div>
